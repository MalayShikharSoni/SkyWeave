<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-white">Build ATS Route</h1>
                <p class="text-sm text-sky-400 mt-1">Construct a route by sequencing waypoints</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('routes.store') }}" x-data="routeBuilder()" x-cloak>
                @csrf
                        ...
                        <div class="glass-card p-6 mb-6">
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="3"
                                          class="form-input-dark" placeholder="Optional route description...">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="lg:col-span-3">
                        <div class="glass-card p-6">
                            ...
                            <div class="mt-6 flex items-center gap-3" x-show="routeWaypoints.length >= 2">
                                ...
                                <a href="{{ route('routes.index') }}" class="btn-secondary">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        function routeBuilder() {
            return {
                ...
                addWaypoint() {
                    ...
                    // Allow duplicate waypoints in a route (valid in ATS routing)
